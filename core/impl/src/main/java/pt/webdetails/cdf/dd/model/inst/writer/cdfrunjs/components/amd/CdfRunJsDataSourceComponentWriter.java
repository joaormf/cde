...
public class CdfRunJsDataSourceComponentWriter extends JsWriterAbstract implements IThingWriter {
  ...
  private void renderBuiltinCdaDatasource( StringBuilder out, CdfRunJsDashboardWriteContext context,
    ...
    String refreshPeriod = dataSourceComp.tryGetPropertyBindingByName( PropertyValue.COMPONENT_REFRESH_RATE ) != null ? dataSourceComp.tryGetPropertyBindingByName( PropertyValue.COMPONENT_REFRESH_RATE).getValue() : "0";
